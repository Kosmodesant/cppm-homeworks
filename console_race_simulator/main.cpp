...
int main()
{
	...
	for (int i = 0; i < rows; i++)                     // UPDATE:  there is no god
	{
	...
	cout << "_____________¶¶¶¶¶¶¶" << "\n";
	cout << "____________¶¶¶¶¶¶¶¶¶" << "\n";
	cout << "___________¶¶¶¶¶¶¶¶¶¶¶________________¶¶¶¶¶¶" << "\n";
	cout << "__________¶¶¶¶¶¶¶¶¶¶¶¶¶______________¶¶¶¶¶0¶¶¶¶¶¶" << "\n";
	cout << "_________¶¶¶¶¶¶¶¶¶¶¶¶¶¶¶¶____________¶¶¶¶¶¶¶¶¶¶¶¶" << "\n";
	...
	cout << "___¶¶¶¶¶______________¶¶¶¶¶" << "\n";
	cout << "__¶¶¶¶¶¶______________¶¶¶¶" << "\n";
	cout << "__¶¶¶_¶¶______________¶¶¶¶" << "\n";
	cout << "___¶¶_¶¶______________¶¶¶" << "\n";
	cout << "___¶¶__¶______________¶¶" << "\n";
	cout << "___¶¶__¶¶_____________¶¶" << "\n";
	cout << "___¶¶¶__¶¶¶¶__________¶¶¶¶" << "\n";
	cout << "___¶¶¶¶__¶¶¶_________¶¶¶¶¶¶" << "\n";
	cout << "____¶¶¶______________¶¶¶" << "\n";
