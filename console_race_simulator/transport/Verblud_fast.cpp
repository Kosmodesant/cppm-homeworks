...
// 
// 
//      ТОЖЕ ВЕРБЛУД, ТОЛЬКО ТРЕВОЖНЫЙ


#include "Verblud_fast.h"
Verblud_fast::Verblud_fast() :Verblud_fast("verblud", 40, 10) {}

double Verblud_fast::metod_finish1(const int distance)
{
...
float Verblud_fast::metod_relax(const int distance, const int times) //метод вычисления общего времени остановок
{
